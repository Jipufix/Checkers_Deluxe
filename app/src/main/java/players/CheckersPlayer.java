...
public class CheckersPlayer extends GameHumanPlayer implements View.OnTouchListener {
    ...
    public void setAsGui(GameMainActivity activity) {
        ...
        surfaceView = (TTTSurfaceView)myActivity.findViewById(edu.up.cs301.game.R.id.surfaceView);
    ...
    public View getTopView() {
        return myActivity.findViewById(edu.up.cs301.game.R.id.top_gui_layout);
    }
